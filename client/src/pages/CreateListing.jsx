      ...
      <h1 className='text-3xl font-bold text-center my-7'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
          ...
          <div className='flex gap-2'>
            <input type='checkbox' id='sale' className='w-5 accent-blue-600' />
            <span>Sell</span>
          </div>
          <div className='flex gap-2'>
            <input type='checkbox' id='rent' className='w-5 accent-blue-600' />
            <span>Rent</span>
          </div>
          <div className='flex gap-2'>
            <input type='checkbox' id='parking spot' className='w-5 accent-blue-600' />
            <span>Parking Spot</span>
          </div>
          <div className='flex gap-2'>
            <input type='checkbox' id='furnished' className='w-5 accent-blue-600' />
            <span>Furnished</span>
          </div>
          <div className='flex gap-2'>
            <input type='checkbox' id='offer' className='w-5 accent-blue-600' />
            <span>Offer</span>
          </div>
        </div>
